...
String ID ="";
    public void saveStudentInform() {
        ...
        while (true) {
            ...
            System.out.println("1." + enumeration.Subject.JAVA);
            System.out.println("2." + enumeration.Subject.OOP);
            System.out.println("3." + enumeration.Subject.SPRING);
            System.out.println("4." + enumeration.Subject.JPA);
            System.out.println("5." + enumeration.Subject.MYSQL);
        ...
        while (true) {
            ...
            System.out.println("1." + enumeration.Subject.DESIGNPATTERN);
            System.out.println("2." + enumeration.Subject.SPRINGSEQURITY);
            System.out.println("3." + enumeration.Subject.REDIS);
            System.out.println("4." + enumeration.Subject.MONGODB);
