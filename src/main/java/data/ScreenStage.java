...
public class ScreenStage {
    ...
    private void screenInitializationStage() {
        ...
        screenStageMap.put(ScreenData.SelectSubjectE, "(필수)과목을 선택헤주세요. (3개 이상 선택해야 합니다.) 과목명만 입력해 주세요");
        screenStageMap.put(ScreenData.SelectSubjectO, "(선택)과목을 선택헤주세요. (2개 이상 선택해야 합니다.) 과목명만 입력해 주세요");
